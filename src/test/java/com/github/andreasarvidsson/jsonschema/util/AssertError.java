...
public abstract class AssertError {
    ...
    public static void assertError(final ValidationReport report, final String property, final String name,
    ...
    public static void assertErrorMessage(final ValidationReport report, final String property, final String name,
    ...
    public static void assertErroMessage(final Error error, final String property, final String name,
            final String message) {
        Assertions.assertEquals(property, error.property, "Error.property");
        Assertions.assertEquals(name, error.name, "Error.name");
