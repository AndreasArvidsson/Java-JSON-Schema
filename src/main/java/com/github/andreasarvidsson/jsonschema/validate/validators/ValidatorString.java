...
public class ValidatorString implements Validator {
    ...
    private void validateMinLength(final List<Error> errors, final String path, final Object instance,
            final JsonSchema jsonSchema) {
    ...
    private void validateMaxLength(final List<Error> errors, final String path, final Object instance,
            final JsonSchema jsonSchema) {
    ...
    private void validatePattern(final List<Error> errors, final String path, final Object instance,
            final JsonSchema jsonSchema) {
